...
import dev.mruniverse.guardianrftb.core.utils.*;
...
public final class GuardianRFTB extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        public void run() {
            ...
            String mode = instance.fileStorage.getControl(GuardianFiles.SETTINGS).getString("settings.pluginMode");
                        ...
                        if (optionalXMaterial.isPresent()) {
                            ...
                            if (m.parseMaterial() != null) {
                                ...
                                if (items.get("Playing.BeastInventory." + beastDefaultInv + ".lore") != null) {
                                    item = getEnchantmentList(item, GuardianFiles.ITEMS, "Playing.BeastInventory." + beastDefaultInv + ".enchantments");
                                }
                ...
                try {
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            ...
                            if (items.get("Playing.BeastArmor.Helmet.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "Playing.BeastArmor.Helmet.enchantments");
                            }
                            beastHelmet = item;
                        }
                    } else {
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            item = getItem(m, ItemName, ItemLore);
                            if (items.get("Playing.BeastArmor.Helmet.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "Playing.BeastArmor.Chestplate.enchantments");
                            }
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            item = getItem(m, ItemName, ItemLore);
                            if (items.get("Playing.BeastArmor.Helmet.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "Playing.BeastArmor.Leggings.enchantments");
                            }
                            beastLeggings = item;
                        }
                    } else {
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            item = getItem(m, ItemName, ItemLore);
                            if (items.get("Playing.BeastArmor.Helmet.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "Playing.BeastArmor.Boots.enchantments");
                            }
                            beastBoots = item;
                        }
                    } else {
                            ...
                            if (optionalXMaterial.isPresent()) {
                                ...
                                if (m.parseMaterial() != null) {
                                    ...
                                    if (items.get("lobby." + lItems + ".enchantments") != null) {
                                        item = getEnchantmentList(item, GuardianFiles.ITEMS, "lobby." + lItems + ".enchantments");
                                    }
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            ...
                            if (items.get("InGame.RunnerKit.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "InGame.RunnerKit.enchantments");
                            }
                            kitRunner = item;
                            RunnerSlot = ItemSlot;
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            ...
                            if (items.get("InGame.BeastKit.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "InGame.BeastKit.enchantments");
                            }
                            kitBeast = item;
                            beastSlot = ItemSlot;
                    ...
                    if (optionalXMaterial.isPresent()) {
                        ...
                        if (m.parseMaterial() != null) {
                            ...
                            if (items.get("InGame.Exit.enchantments") != null) {
                                item = getEnchantmentList(item, GuardianFiles.ITEMS, "InGame.Exit.enchantments");
                            }
                            exitItem = item;
                            exitSlot = ItemSlot;
    ...
    public ItemStack getEnchantmentList(ItemStack item, GuardianFiles fileOfPath, String path) {
    ...
    private void nmsSetup() {
        try {
            nmsHandler = (NMS) Class.forName("dev.mruniverse.guardianrftb.nms." + NMSenum.getCurrent() + ".NMSHandler").getConstructor(new Class[0]).newInstance(new Object[0]);
