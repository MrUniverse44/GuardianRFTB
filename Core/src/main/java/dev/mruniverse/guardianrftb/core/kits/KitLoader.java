        ...
        switch (kitType) {
            case BEAST:
                if(data.getKits().contains(kitID)) {
                    ...
                    String selected = plugin.getStorage().getControl(GuardianFiles.MESSAGES).getString("messages.inGame.kits.selectedKit");
                    ...
                    if(data.getCoins() >= kitInfo.getPrice()) {
                        ...
                        data.addKit(kitID);
                        data.setSelectedKit(kitID);
                        String buyKit = plugin.getStorage().getControl(GuardianFiles.MESSAGES).getString("messages.inGame.kits.buyKit");
