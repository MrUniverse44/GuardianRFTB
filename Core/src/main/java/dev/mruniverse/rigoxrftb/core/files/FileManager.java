...
public class FileManager {
    ...
    public void loadConfiguration() {
        ...
        addConfig(Files.MENUS, "chests.armor.helmet.enchantments",enchants);
        ...
        addConfig(Files.MENUS, "chests.armor.chestplate.enchantments",enchants);
        ...
        addConfig(Files.MENUS, "chests.armor.leggings.enchantments",enchants);
        ...
        addConfig(Files.MENUS, "chests.armor.boots.enchantments",enchants);
        enchants = new ArrayList<>();
        enchants.add("FIRE_ASPECT, 2");
        enchants.add("SHARPNESS, 3");
        addConfig(Files.MENUS, "chests.attack.sword.name", "&aDiamond Sword");
        addConfig(Files.MENUS, "chests.attack.sword.slot", 21);
        addConfig(Files.MENUS, "chests.attack.sword.lore", menuList);
        addConfig(Files.MENUS, "chests.attack.sword.item", "DIAMOND_SWORD");
        addConfig(Files.MENUS, "chests.attack.sword.enchantments",enchants);
        addConfig(Files.MENUS, "chests.attack.bow.name", "&aHardcore Bow");
        addConfig(Files.MENUS, "chests.attack.bow.slot", 22);
        addConfig(Files.MENUS, "chests.attack.bow.lore", menuList);
        addConfig(Files.MENUS, "chests.attack.bow.item", "BOW");
        enchants = new ArrayList<>();
        enchants.add("FLAME, 1");
        enchants.add("INFINITY, 1");
        addConfig(Files.MENUS, "chests.attack.bow.enchantments",enchants);
        addConfig(Files.MENUS, "chests.attack.arrow.name", "&aHardcore Arrow");
        addConfig(Files.MENUS, "chests.attack.arrow.slot", 23);
        addConfig(Files.MENUS, "chests.attack.arrow.lore",menuList);
        enchants = new ArrayList<>();
        enchants.add("KB, 1");
        addConfig(Files.MENUS, "chests.attack.arrow.item","ARROW");
        addConfig(Files.MENUS, "chests.attack.arrow.enchantments",enchants);
        addConfig(Files.MENUS, "chests.attack.potion.name","&aHardcore Potion");
        addConfig(Files.MENUS, "chests.attack.potion.slot",31);
        addConfig(Files.MENUS, "chests.attack.potion.lore",menuList);
        addConfig(Files.MENUS, "chests.attack.potion.item","POTION");
    }
