...
public class FileManager {
    ...
    public void loadConfiguration() {
        ...
        lore.add("[openMenu]gameSelector");
        ...
        addConfig(Files.ITEMS,"lobby.gameSelector.item","BED");
        ...
        addConfig(Files.ITEMS,"lobby.gameSelector.actions",actions);
        addConfig(Files.ITEMS,"lobby.Shop.toggle",true);
        addConfig(Files.ITEMS,"lobby.Shop.item","BED");
        addConfig(Files.ITEMS,"lobby.Shop.name","&aGame Selector");
        addConfig(Files.ITEMS,"lobby.Shop.lore",new ArrayList<String>());
        addConfig(Files.ITEMS,"lobby.Shop.slot",0);
        actions = new ArrayList<>();
        actions.add("[openMenu]Shop");
        addConfig(Files.ITEMS,"lobby.Shop.actions",actions);
        actions = new ArrayList<>();
        actions.add("[openMenu]playerSettings");
        addConfig(Files.ITEMS,"lobby.PlayerSettings.toggle",true);
        addConfig(Files.ITEMS,"lobby.PlayerSettings.item","BED");
        addConfig(Files.ITEMS,"lobby.PlayerSettings.name","&aYour settings");
        addConfig(Files.ITEMS,"lobby.PlayerSettings.lore",lore);
        addConfig(Files.ITEMS,"lobby.PlayerSettings.slot",0);
        addConfig(Files.ITEMS,"lobby.PlayerSettings.actions",actions);
        addConfig(Files.ITEMS,"lobby.LobbySelector.toggle",true);
        addConfig(Files.ITEMS,"lobby.LobbySelector.item","BED");
        addConfig(Files.ITEMS,"lobby.LobbySelector.name","&aLobby Selector");
        addConfig(Files.ITEMS,"lobby.LobbySelector.lore",lore);
        addConfig(Files.ITEMS,"lobby.LobbySelector.slot",0);
        actions = new ArrayList<>();
        actions.add("[openMenu]lobbySelector");
        addConfig(Files.ITEMS,"lobby.LobbySelector.actions",actions);
        ...
        addConfig(Files.ITEMS,"lobby.Exit.slot",0);
        actions = new ArrayList<>();
        actions.add("[send]hub");
        addConfig(Files.ITEMS,"lobby.Exit.actions",actions);
